...
from flask import Flask, request, Response, jsonify,render_template,redirect, url_for, flash, session,send_from_directory
...
def train_model():
    try:
        ...
        model.train(data=prepare_training_data(), epochs=3)  # Adjust epochs as needed
